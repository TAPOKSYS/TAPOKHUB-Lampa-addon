...
Интерфейс плагина выбирается по языку Lampa: русский, английский. Сообщения сервера, Telegram-бот и скрипты установки подстраиваются под язык запроса, отправителя или системы (см. [Язык](docs/INSTALL.md#язык)).
